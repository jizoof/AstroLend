      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-12">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-sm border border-border/50">
            <h2 className="text-2xl font-bold mb-4">What is AstroLend?</h2>
            <p className="text-muted-foreground leading-relaxed">
              AstroLend is a decentralized lending protocol that allows users to supply assets to earn interest and
              borrow assets by providing collateral. Built on the Stellar blockchain, AstroLend leverages Soroban smart
