...
import { astrolendContractAPI, sorobanService, type DashboardData } from "@/services/soroban-service"
...
export default function CollateralPage() {
  ...
  const loadData = useCallback(async () => {
      ...
      const [dashboard, balances, price] = await Promise.all([
        astrolendContractAPI.getDashboardData(publicKey || ""),
        astrolendContractAPI.getWalletBalances(publicKey || ""),
  ...
  const handleDeposit = async () => {
    ...
    await depositTx.execute(() =>
      astrolendContractAPI.depositCollateral(publicKey, amount, signTx)
    )
  }
  ...
  const handleWithdraw = async () => {
    ...
    await withdrawTx.execute(() =>
      astrolendContractAPI.withdrawCollateral(publicKey, amount, signTx)
    )
  }
