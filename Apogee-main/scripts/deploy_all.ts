/**
 * AstroLend All-in-One Deployment Script
 *
 * Deploys and initializes all AstroLend contracts in one go:
 *
...
const WASM_FILES = {
  pool: "astrolend_pool.wasm",
  oracle: "astrolend_price_oracle.wasm",
  interestRateModel: "astrolend_interest_rate_model.wasm",
};
...
async function main() {
  printBanner("AstroLend Full Deployment");
