...
import { astrolendContractAPI, type DashboardData } from "@/services/soroban-service"
...
export default function LendWithdrawPage() {
  ...
  const handleSupply = async () => {
    ...
    await supplyTx.execute(() => 
      astrolendContractAPI.supplyLiquidity(publicKey, amount, signTx)
    )
  }
  ...
  const handleWithdraw = async () => {
    ...
    await withdrawTx.execute(() =>
      astrolendContractAPI.withdrawLiquidity(publicKey, amount, signTx)
    )
  }
